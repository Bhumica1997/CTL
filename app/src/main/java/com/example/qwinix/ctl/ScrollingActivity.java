package com.example.qwinix.ctl;
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    public static class TestFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
           ...
           /* RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recyclerview);
            ...
            ImageButton img = view.findViewById(R.id.imageButton2);
    ...
    public static class TestFragment1 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            View view = inflater.inflate(R.layout.tab_page, container, false);
            //Button callbtn = view.findViewById(R.id.button1);
    ...
    static class TestAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ((TextView) holder.itemView).setText("#186, KBL Gardenia, near basavanapura , Vijayanagar 4th stage, Mysuru-570018");
            ((TextView) holder.itemView).setText("phone number");
            //((TextView) holder.itemView).setText("timing" + (position + 2));*/
        }
    }
